...
class EConfig(PretrainedConfig):
    ...
    Args:
        ...
        num_attention_heads (`int`, *optional*, defaults to 32):
            Number of attention heads for each layer in the Transformer encoder
        ...
        rope_scaling (`Dict`, *optional*):
            ...
            See the following thread for more information on how these
            scaling strategies behave:
            https://www.reddit.com/r/LocalLLaMA/comments/14mrgpr/dynamically_scaled_rope_further_increases/
            This is an experimental feature, subject to breaking API
