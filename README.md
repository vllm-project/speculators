...
- **D-PARD Training Objective**: Added a DSpark-native Rényi-half actor with detached exact-overlap position weights. Enable it with `--loss-fn renyi_half --per-position-loss-weight dpard --dpard-alpha 0.5`.
