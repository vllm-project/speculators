...
def create_train_val_loaders(
    *,
    ...
    is_sp_data_rank = get_sp_rank() == 0
    effective_num_workers = num_workers if is_sp_data_rank else 0
    effective_prefetch = prefetch_factor if is_sp_data_rank else None
