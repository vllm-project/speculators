...
- EAGLE1: Based on Llama2, no bias in fusion layer, standard layernorms
- HASS: Based on Llama3, bias in fusion layer, extra layernorms
...
class LlamaEagleSpeculatorConfig(TransformerSpeculatorConfig):
    ...
    model_type: Literal["llama_eagle"] = "llama_eagle"
    ...
    # Variant selection
    eagle_variant: Literal["eagle_v1", "hass"] = Field(
        default="eagle_v1",
    ...
    replace_first_layer_norm: bool = Field(
        ...
        description=(
            ...
            "This is a key EAGLE optimization."
        )
    )
...
class LlamaEagleSpeculator(PreTrainedModel):
    """
