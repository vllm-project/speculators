...
try:
    ...
    Qwen3NextRotaryEmbedding = None  # type: ignore[assignment,misc]
...
class FastMTPComponents(NamedTuple):
    ...
    :param rotary_emb_class: Rotary embedding class for position encoding
...
_mimo_components = FastMTPComponents(
    attention_class=Qwen2Attention,
    mlp_class=Qwen2MLP,
    norm_class=Qwen2RMSNorm,
    rotary_emb_class=Qwen2RotaryEmbedding,
