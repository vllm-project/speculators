...
2. **Convert an existing model** from a third-party library to the Speculators format for easy deployment with vLLM - See [Features](user_guide/features/index.md).
