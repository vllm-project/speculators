...
| | Eagle-3 | P-EAGLE | DFlash | DSpark | MTP | | ------------------- | ------------- | ------------------- | ------------------- | ------------------- | --------------------------- | | **Draft layers** | Llama-style | Llama-style | Qwen3-style | Qwen3-style | Native MTP layers | | **Verifier models** | Any supported | Any supported | Any supported | Any supported | Models with native MTP only | | **Training mode** | From scratch | From scratch | From scratch | From scratch | Finetune existing MTP head | | **Speculators** | Mature | Newer, growing fast | Newer, growing fast | Newer, growing fast | Newer, growing fast | | **vLLM** | Mature | Newer, growing fast | Newer, growing fast | Newer, growing fast | Newer, growing fast |
