...
**Pros:** Lower disk usage, no pre-generation step
**Cons:** Requires vLLM server, slower per epoch
...
**Pros:** Faster training, reproducible, no vLLM dependency during training
**Cons:** Requires disk space, pre-generation time
