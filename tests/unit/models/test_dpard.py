...
def test_dpard_credit_is_raw_suffix_survival_without_c_denominator() -> None:
    ...
    # uncalibrated suffix=[2.232,1.332,0.612].
...
def test_weighted_mean_uses_valid_position_count_not_weight_mass() -> None:
...
def test_dpard_credit_rejects_invalid_shape_and_rho() -> None:
