...
uv pip install -q trackio

# Configuration
VERIFIER_NAME_OR_PATH="openai/gpt-oss-20b"
HF_DATASET="nm-testing/ultrachat_gpt_oss_20b_hidden_states"
OUTPUT_PATH="./output/gpt_oss_20b_ultrachat"
DATA_PATH="./output/data/gpt_oss_20b"
...
# Run training
COMMON_ARGS="--verifier-name-or-path $VERIFIER_NAME_OR_PATH --data-path $DATA_PATH --save-path $OUTPUT_PATH --epochs 5 --lr 3e-5 --total-seq-len 8192 --logger trackio --run-name gpt_oss_20b_ultrachat"
