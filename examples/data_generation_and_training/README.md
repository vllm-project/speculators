...
- `qwen3_omni_thinking_llava.py`: multimodal LLaVA-Instruct pipeline using `prepare_data.py` + `data_generation_offline2.py` to train the same Qwen3 DFlash draft against `Qwen/Qwen3-Omni-30B-A3B-Thinking`.
